...
<div class="container-fluid">
    ...
    <a href="add.php" class="btn btn-primary">New Apartment </a>
<?php
    $st =$pdo -> query("SELECT * FROM apartments");
...
<a class="btn btn-danger" href="hide.php?num=<?php echo $row["id"]; ?>">hide</a>
<a class="btn btn-info" href="show.php?id=<?php echo $row["id"]; ?>">show</a>
<a class="btn btn-danger" href="delete.php?num=<?php echo $row["id"]; ?>">Delete</a>
<a class="btn btn-warning" href="edit.php?num=<?php echo $row["id"]; ?>">Edit</a>
